...
**Mental model for Codex:** Focus edits on `_pages/about.md`. Everything else supports building, styling, or provides assets. Only serve locally at the very end for debugging.
...
print("AGENTS.md has been written successfully!")